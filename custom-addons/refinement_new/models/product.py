...
class product_template(models.Model):
	...
	handling_group_id = fields.Many2one(
		'handling.group', string='Handling Group')
	branding_ids = fields.Many2many(
		'branding.item',
		'branding_item_rel',
		'product_id',
		'brand_id',
		string="Branding Items"
	)
	...
	mfg_country = fields.Many2one(
		'res.country', string="Country of Manufacturer")
...
class product_product(models.Model):
	...
	is_template = fields.Boolean(
		"Template Product",
		related='product_tmpl_id.is_template',
		default=False
	)
